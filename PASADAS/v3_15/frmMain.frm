...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmMain 
   Caption         =   "Control de Pre-Impresion de Cartillas de 90 bolos V3.15"
   ClientHeight    =   5190
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   4980
...
Private Sub cmdNivelNegro_Click()
    ...
    mdmRutinasOpcionales.CambiarNivelColorNegro
...
Private Sub cmdNivelNegroCodificacion_Click()
    ...
    mdmRutinasObligatorias.CambiarNivelColorNegroSoloCodificacion
    ...
    Beep
    MsgBox Prompt:="Se aplico el %negro a las capas de Codificación", Buttons:=vbExclamation
End Sub
...
Private Sub UserForm_Initialize()
    ...
    If Len(Dir(sINI_FILE)) = 0 Then
        ...
        sReturn = sManageSectionEntry(iniWrite, "Obligatorias", "NivelNegroQR", sINI_FILE, "100")
        ...
        sReturn = sManageSectionEntry(iniWrite, "Opcionales", "NivelNegroQR", sINI_FILE, "100")

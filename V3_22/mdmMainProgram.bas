...
'Release Notes
' Version 3.22:
' Se agregan al formulario boxes para editar FONT y SIZE de la letra de Numeros de cartilla
' Se agregan al formulario boxes para editar FONT de la letra de NumSerie

...
Sub GenerarBloquesBase()
    ...
    Dim UbicacionBD, UbicacionIcono, FontLetras, FontNumeros As String
    Dim TamañoLetras, TamanoNumeros, AnchoPlumaLetras, EstiramientoLetras As Double
    ...
    'Atributos para la impresion de Cartillas de Numeros
    FontNumeros = frmMain.txt_FontNumeros.Value
    TamanoNumeros = Val(frmMain.txt_TamanoNumeros.Value)
                    ...
                    For s = 0 To NumColsBox - 1
                        ...
                        If MyArray(NumBoxActual, NumCasillaActual) <> "" Then
                            ...
                            If frmMain.chk_BaseLetras.Value = False Then
                                ...
                                Set shDATA_OBJECT1 = ActivePage.Layers("Layer4B").CreateArtisticText(PosRelativaX, PosRelativaY, MyArray(NumBoxActual, NumCasillaActual), , , FontNumeros, TamanoNumeros, cdrTrue, , , cdrCenterAlignment)
                            Else
                                'Imprime Letra(s)
                                Set shDATA_OBJECT1 = ActivePage.Layers("Layer4B").CreateArtisticText(PosRelativaX, PosRelativaY, MyArray(NumBoxActual, NumCasillaActual), , , FontLetras, TamañoLetras, cdrFalse, , , cdrCenterAlignment)
...
Sub SampleINIRespaldoBase()
    ...
    sReturn = sManageSectionEntry(iniWrite, "Modulo_Base", "FontNumeros", sINI_FILE, frmMain.txt_FontNumeros.Value)
    sReturn = sManageSectionEntry(iniWrite, "Modulo_Base", "TamanoNumeros", sINI_FILE, frmMain.txt_TamanoNumeros.Value)
